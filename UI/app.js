...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        var url = "http://127.0.0.1:5000/classify_image"; /* helps to bind it to backend server*/

        $.post(url, {                  /* to post the url  it*/
            image_data: file.dataURL
        },function(data, status)/* it is respones from server*/ {
            /* 
